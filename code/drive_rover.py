...
class RoverState():
    def __init__(self):
        ...
        self.action_timer = ActionTimer(2)
        ...
        self.nav_weights = None # Weights of navigable terrain pixels
        ...
        self.threshold_reverse_velocity = 0.08
        ...
        self.seenmap = np.zeros((200, 200), dtype=np.bool)
        self.seen_weight_multiplier = 0.5
